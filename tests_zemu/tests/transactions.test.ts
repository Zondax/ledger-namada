...
function hashSignatureSec(pubkeys: Buffer[], salt: Buffer, hashes: Buffer[], indices: Buffer, signature: Buffer | null, prefix: Uint8Array | null) {
...
const TEST_DATA = [
  {
    ...
    sectionHashes: [
      Buffer.from('b18d30a556f0e2cf783134bd74df96b21e44a25e90eef3c3a15ec332c6a93a9a', 'hex'),
  ...
  },
  {
    ...
    sectionHashes: [
      Buffer.from('8efe673b496344b1bbc14dd4f48036fbf505d5a71968c919b9629991161c71ff', 'hex'),
  ...
  },
  {
    ...
    sectionHashes: [
      Buffer.from('4a91ed080e8fae63e8ca0f34fbe8d4f86c47022d8a45e0bedc3b6c7abaf12927', 'hex'),
  ...
  },
  {
    ...
    sectionHashes: [
      Buffer.from('1166ce0d915e2d362c3d90e635cafab3beaaad39c490684473dacc7ee0d01b38', 'hex'),
  ...
  },
  {
    ...
    sectionHashes: [
      Buffer.from('20a62e73d43ce617d99f10207cd6600b00bb3f0a5ab16fbd430c4fdb0713d1bb', 'hex'),
  ...
  },
  {
    ...
    sectionHashes: [
      ...
      Buffer.from('11db58130f36c86cdbe872c396158aa4d0792ec824237df6c6be8fa9e7882cca', 'hex'),
      Buffer.from('e4d9a0695da3d772008b5ac0b77a55350c9d8380b2d5418016b7200f29af42b2', 'hex'),
      Buffer.from('4ca0aca5228a1bc0fd295b971f63369e618d5ff7df77664ace61668bd95fee9d', 'hex'),
    ],
  },
]
