...
const TEST_DATA = [
  {
    ...
    headerHash: Buffer.from('6c8a8d627197015b83bf628b51f955f1f56e88ff62f8ce1315871c6dbfeefaaf', 'hex'),
    dataHash: Buffer.from('b91572f3df344a146b2cb57071d0250b826365b60bcfdb89673e7eb296ec1363', 'hex'),
    codeHash: Buffer.from('453cb84daea043f101504b77129197d6c80e62d66e8eb1c8e4cb1da20fa219fd', 'hex'),
  },
]
