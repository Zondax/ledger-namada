...
[![GithubActions](https://github.com/Zondax/ledger-anoma/actions/workflows/main.yml/badge.svg)](https://github.com/Zondax/ledger-anoma/blob/main/.github/workflows/main.yaml)
...
This project contains the Anoma app for Ledger Nano S Nano S+ and X.

- Ledger Nano S/S+/X Anoma app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-anoma/releases). You only need `installer.sh`
