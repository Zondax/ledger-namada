...
static const txn_types_t allowed_txn[] = {
    ...
    {"tx_shielding_transfer.wasm", ShieldingTransfer},
    {"tx_unshielding_transfer.wasm", UnshieldingTransfer},
    {"tx_shielded_transfer.wasm", ShieldedTransfer},
    {"tx_transparent_transfer.wasm", TransparentTransfer},
