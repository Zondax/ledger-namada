...
static zxerr_t computeKeys(keys_t * saplingKeys) {
    ...
    // Compute diversifier
    CHECK_PARSER_OK(computeDiversifier(saplingKeys->dk, saplingKeys->div_start_index, saplingKeys->div));

    // Compute address
    CHECK_PARSER_OK(computePkd(saplingKeys->ivk, saplingKeys->div, saplingKeys->address));
